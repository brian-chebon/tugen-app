...
class AppLocalizations {
  ...
  static final Map<String, Map<String, String>> _localizedValues = {
    ...
    'tug': {
      ...
      'advanced': 'Ne ngunon',
      'listenAndRepeat': 'Igas ak iit kole',
      'translateThis': 'Tafsiri nee',
      'whatDoYouHear': 'Igasie nee?',
      'whatDoesThisMean': 'Nee ne kimwa?',
      'signIn': 'Inweet',
      'signUp': 'Sigil',
      ...
      'clearCacheDesc': 'Tep faili che kimuut',
      'clearCacheConfirm': 'Itep kumbukumbu?',
      'clearCacheMsg': 'Nee kitepchi sauti tugul che kimuut. Imuute kole angwan.',
      'cancel': 'Birra',
      'clear': 'Tep',
      'cacheCleared': 'Kitep kumbukumbu',
      'cacheSize': 'Barak ne kumbukumbu',
      'audioCache': 'Kumbukumbu che sauti',
      'storage': 'Hifadhi',
      'account': 'Akaunti',
      'ok': 'Sawa',
      'done': 'Kigol',
      ...
      'saveProgress': 'Yai akaunti agoi ihifadhi maendeleo!',
      'noHeartsTitle': 'Kigol mugulelnik!',
      'noHeartsMsg': 'Mugulelnik kiyai kole ko koen ibinda. Ine kole angwan.',
      'about': 'Agobo',
      'aboutDesc': 'Programu ne amesinei Kutit ne Tugen',
      'privacyPolicy': 'Sera ne faragha',
      'privacyPolicyDesc': 'Kou ne kiyai ak data',
      'logout': 'Konyo',
      'madeWith': "Kiyai ak chameet agoi chebo ng'aleet ab Tugen",
      'vocabularyDecks': 'Betusiek che msamiati',
      'cardsLabel': 'kadinik',
      'cardsDueForReview': 'kadinik che teech irejewe',
      'review': 'Rejea',
      'allCaughtUp': 'Kigol tugul!',
      'noCardsDue': 'Ma mi kadinik che teech irejewe.',
      'sessionComplete': 'Kigol kipindi!',
      'reviewedCards': 'Kirejew kadinik {count}',
      'tapToReveal': 'Gusa agoi inyor',
      'results': 'Matokeo',
      'correctCount': '{correct} / {total} katoog',
      'needMinCards': 'Teech kadinik 4 anan ichei.',
      'noPhrases': "Ma mi ng'aleekab",
      'noStories': 'Ma mi tisirek.',
      'achievements': 'Koimosiek',
      'version': 'Toleo',
      'calculating': 'Kihesabuni...',
      'notSet': 'Ma kiyai',
      'toggleTranslation': 'Onyesha/ficha tafsiri',
    },
  };
